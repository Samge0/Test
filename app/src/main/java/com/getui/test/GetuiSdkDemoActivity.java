...
public class GetuiSdkDemoActivity extends Activity implements OnClickListener {
    ...
    private static final String MASTERSECRET = "wUx1yX8PZo8i7r4j9XxIH7";
    ...
    private Button btnDataBindList;
    ...
    public void onClick(View v) {
        if (v == clearBtn) {
            ...
            finish();
        } else if (v == btnDataBind) {
            Intent intent = new Intent(this,DataBindActivity.class);
            startActivity(intent);
        } else if (v == btnDataBindList) {
            Intent intent = new Intent(this,DataBindListActivity.class);
            startActivity(intent);
        }
    }
    ...
    private void initView() {
        ...
        btnDataBind = (Button) findViewById(R.id.databind);
        btnDataBind.setOnClickListener(this);
        btnDataBindList = (Button) findViewById(R.id.databind_list);
        btnDataBindList.setOnClickListener(this);
